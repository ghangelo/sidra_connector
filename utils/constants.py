...
IBGE_AGGREGATES_BASE_URL = "https://servicodados.ibge.gov.br/api/v3/agregados"
...
DEFAULT_PERIOD_BATCH_SIZE = 12
MAX_RESPONSE_BYTES = 100 * 1024 * 1024
PLUGIN_USER_AGENT = (
    "SIDRA-Connector-QGIS/2.3 "
    "(https://github.com/ghangelo/sidra_connector)"
)
